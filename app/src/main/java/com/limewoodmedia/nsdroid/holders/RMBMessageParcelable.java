...
public class RMBMessageParcelable implements Parcelable {
	...
	public RMBMessageParcelable(RMBMessage msg) {
		this.msg = new RMBMessage(msg.timestamp, msg.nation, msg.message);
	}
	
	public RMBMessageParcelable(long timestamp, String nation, String message) {
		this.msg = new RMBMessage(timestamp, nation, message);
	}
    ...
    = new Parcelable.Creator<RMBMessageParcelable>() {
		public RMBMessageParcelable createFromParcel(Parcel in) {
			RMBMessageParcelable data = new RMBMessageParcelable(in.readLong(), in.readString(), in.readString());
